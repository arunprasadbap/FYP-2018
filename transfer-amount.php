...
//    echo "<pre>";
//    print_r($_SESSION['transfer']['student_id']);
//    echo "</pre>";
    
    $student_id = $_SESSION['transfer']['student_id'];
    $amount     = $_SESSION['transfer']['amount'];
    $user_name  = $_SESSION['transfer']['user_name'];
    $idnum      = $_SESSION['idnum'];
    
//    echo "INSERT INTO transection_history (userid, amount, date_time, username, formid) VALUES ('$student_id', '$amount', now(), '$user_name','$idnum')";
//    die;
    
     //insert for transfer history
    $mysqli->query( "INSERT INTO transection_history (userid, amount, date_time, username, formid) VALUES ('$student_id', '$amount', now(), '$user_name','$idnum')");
