<?php session_start();
require 'script/edit.php'; $the_item= $edit->fetch_assoc();?>
...
<form class="form2" method="post" action="script/update.php?product_id=<?php echo $the_item['id']?>" >
<fieldset>

<!-- Form Name -->
<legend>Edit Breakfast Page</legend>
...
<div class="form-group">
  ...
  <div class="col-lg-9">
  <input name="stock" value=" <?php echo $the_item['quantity'];?>" type="number"/>
