...
<div class="gallery">
  <a><img src="images/breakfast/<?php echo $Food['img']; ?>" id="image" class="img-responsive" width="300" height="200">
         <div><h6><?php echo '<b>'.$Food['breakfast'].'</b>'.'&nbsp;'.'&nbsp;'.'RM'.$Food['breakfast_amount']; ?></h6>
